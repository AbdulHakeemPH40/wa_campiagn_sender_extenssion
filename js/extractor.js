...
export function initExtractor() {
  ...
  if (extractFromGroupBtn) {
    addEventListenerWithCleanup(extractFromGroupBtn, 'click', () => {
  ...
  if (extractFromChatBtn) {
    addEventListenerWithCleanup(extractFromChatBtn, 'click', () => {
      requestChatContacts();
    });
  }

  if (extractFromContactsBtn) {
    addEventListenerWithCleanup(extractFromContactsBtn, 'click', () => {
